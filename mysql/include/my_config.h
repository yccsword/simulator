...
#define DEFAULT_MYSQL_HOME "/root/mysql-5.7.17/mysql_release"
#define SHAREDIR "/root/mysql-5.7.17/mysql_release/share"
#define DEFAULT_BASEDIR "/root/mysql-5.7.17/mysql_release"
#define MYSQL_DATADIR "/root/mysql-5.7.17/mysql_data"
#define MYSQL_KEYRINGDIR "/root/mysql-5.7.17/mysql_release/keyring"
#define DEFAULT_CHARSET_HOME "/root/mysql-5.7.17/mysql_release"
#define PLUGINDIR "/root/mysql-5.7.17/mysql_release/lib/plugin"
#define DEFAULT_SYSCONFDIR "/root/mysql-5.7.17/mysql_conf"
